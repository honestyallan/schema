...
public class CalPriceFactory {
    private static final String CAL_PRICE_PACKAGE = "cn.slimsmart.kafka.demo.region";//这里是一个常量，表示我们扫描策略的包
    ...
    public CalPrice createCalPrice(Player player) {
        ...
        throw new RuntimeException("策略获得失败"+player.getTotalAmount());
    }
