...
import cn.vincent.demo.app.aop.demo1.annotation.LogAccess;
...
public class TestServiceImpl2 implements TestService {
    ...
    public boolean add(String content) {
        System.out.println("add method in TestServiceImpl2 :" + content);
    ...
    public boolean update(String content) {
        System.out.println("update method in TestServiceImpl2 :" + content);
        if (StringUtils.isNotBlank(content) && "t".equalsIgnoreCase(content)) {
            throw new RuntimeException("故意抛出去的");
        }
        return false;
