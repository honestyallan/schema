 ...
 * @version 1.1.2
 */
package com.cib.epay.sdk.common;

import com.cib.epay.sdk.util.IPUtil;
...
public class Configure {
    ...
    // 商户号，格式如A0000001
//    private static String appid = "Q0000279";
//    private static String appid = "Q0000645";
    private static String appid = "Q0000706";


    // 商户私有密钥，该密钥需要严格保密，只能出现在后台服务端代码中，不能放在可能被用户查看到的地方，如html、js代码等
    // 在发送报文给收付直通车时，会使用该密钥进行签名
    // 在收到收付直通车返回的报文时，将使用该密钥进行验签
//    private static String commKey = "D6893DBCB1544B0AAAC73C562C06F1EC";
//    private static String commKey = "F5BADD95B9CD4F8284F4E4F8246AB2EE";
    private static String commKey = "9D7BD4438A964C8B819F8563682D59DD";
...
//    private static String sub_mrch = "SDK-JAVA测试商户";
    private static String sub_mrch = "威富通广州测试";
