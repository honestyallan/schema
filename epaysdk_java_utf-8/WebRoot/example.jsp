...
<html>
  ...
  <body>
    ...
    <input type="text" name="trac_no" value="<%="TN"+DateTimeUtil.getDateTime()%>" width="32" maxlength="32" placeholder="商户系统跟踪号" />
    ...
    <input type="text" name="order_no" value="<%="SDK"+DateTimeUtil.getDateTime()%>" width="32" maxlength="32" placeholder="商户订单号" />
    ...
    <p><b>Ex.2-1</b> 网关支付：</p>
    <form name="gppay" action="epay_redirect.jsp" method="get">
    <input type="text" name="order_no" value="<%="SDK"+DateTimeUtil.getDateTime()%>" width="32" maxlength="32" placeholder="商户订单号" />
    <input type="text" name="order_amount" value="1.00" style="width:100px" maxlength="32" placeholder="订单金额" />
    <input type="text" name="order_title" value="SDK测试订单" width="32" maxlength="12" placeholder="订单标题" />
    <input type="text" name="order_desc" value="欢迎使用收付直通车" width="32" maxlength="32" placeholder="订单描述" />
